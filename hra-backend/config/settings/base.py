...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='hra_db'),
        'USER': config('DB_USER', default='hra_user'),
...
CELERY_TASK_ROUTES = {
    'apps.payslips.tasks.*':      {'queue': 'pdf'},
    'apps.attendance.tasks.*':    {'queue': 'realtime'},
...
# ─── Email ─────────────────────────────────────────────────────────────────────
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='HRA System <noreply@yourcompany.com>')
